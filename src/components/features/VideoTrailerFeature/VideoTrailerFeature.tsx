...
export const VideoTrailerFeature = () => {
    ...
    const [movieTrailerInfVisible, setMovieTrailerInfVisible] = useState(false)
    ...
    useEffect(() => {
        ...
        const handleLoadedMetadata = () => {
            if (videoTrailerElement.current) {
                ...
                setMovieTrailerInfVisible(true)
            }
        }
        if (videoTrailerElement.current) {
            setVideoTrailerContainerSize(videoTrailerElement.current.offsetHeight)
            ...
            {movieTrailerInfVisible &&
                ...
                >
                    ...
                    <p>
                        ...
                        conspirators who destroyed his family. Facing a choice between the love of his life and the fate
                        of
